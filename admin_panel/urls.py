...
urlpatterns = [
    ...
    path('admin_residents/approve/<int:resident_id>/', views.approve_resident, name='approve_resident'),
    path('admin_residents/delete/<int:resident_id>/', views.delete_residents, name='delete_residents'),
    ...
    # CAPTCHA ENDPOINTS
    path('get-captcha/', views.admin_get_captcha, name='admin_get_captcha'),
    path('refresh-captcha/', views.admin_refresh_captcha, name='admin_refresh_captcha'),
    ...
    path('reject-user/<int:id>/', views.reject_user, name='reject_user')
]
